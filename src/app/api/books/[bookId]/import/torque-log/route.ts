...
/**
 * Read a Torque Log (§14), or commit it.
 *
...
/** A torque log runs to hundreds of rows and tens of pages. 50 MB holds any
...
export async function POST(
  ...
  const result = commit
    ? await provider.commitTorqueLogImport(viewer, bookId, file, filename)
    : await provider.previewTorqueLogImport(viewer, bookId, file, filename)
